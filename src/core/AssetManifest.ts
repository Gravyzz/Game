...
// Полный список ассетов для предзагрузки в BootScene — чтобы переходы между
// сценами были мгновенными и фиолетовый фон не «зависал» во время скачивания.
export const ALL_ASSETS: ImageAsset[] = [
  ...BOOT_ASSETS,
  ...WHEEL_ASSETS,
  ...RESULT_ASSETS,
  ...FIRESTARTER_ASSETS,
