...
export const SFX_CATALOG = {
  ...
  knifeThrow: {
    ...
    randomVolume: 0.04,
    variants: [
      variant('transitions/mixkit-air-woosh-1489.wav', 0.72, 1.08),
      variant('gameplay/mixkit-fast-sword-whoosh-2792.wav', 0.48, 1.12),
    ],
  },
  knifeStick: {
    category: 'gameplay',
    ...
    randomVolume: 0.04,
    variants: [
      variant('movement/mixkit-game-ball-tap-2073.wav', 0.72, 0.72),
      variant('ui/kenney-interface/click_004.ogg', 0.52, 0.78),
    ],
  },
  knifeClash: {
    category: 'gameplay',
    ...
    randomVolume: 0.04,
    variants: [
      variant('gameplay/mixkit-metal-hit-woosh-1485.wav', 0.58, 0.9),
      variant('gameplay/mixkit-strong-punches-to-the-body-2198.wav', 0.48, 0.82),
    ],
  },
  heavyImpact: {
    category: 'gameplay',
  ...
  comboCue: {
    ...
    randomVolume: 0.04,
    variants: [
      variant('transitions/mixkit-electric-pop-2365.wav', 0.68, 1.12),
      variant('ui/kenney-interface/click_002.ogg', 0.5, 1.2),
    ],
  },
  comboPress: {
    category: 'rhythm',
    ...
    randomVolume: 0.04,
    variants: [
      variant('rhythm/mixkit-correct-positive-answer-949.wav', 0.58, 1.08),
      variant('ui/kenney-interface/confirmation_002.ogg', 0.52, 1.12),
    ],
  },
  comboClear: {
    category: 'rhythm',
    ...
    duckMusic: 0.08,
    variants: [
      variant('rewards/mixkit-game-bonus-reached-2065.wav', 0.78, 1.04),
      variant('rhythm/mixkit-correct-answer-reward-952.wav', 0.58, 1.02),
    ],
  },
  jump: {
    category: 'gameplay',
  ...
  danceStinger: {
    ...
    randomPitch: 0.006,
    randomVolume: 0.03,
    variants: [variant('rhythm/mixkit-dancing-fit-45.mp3', 0.7)],
  },
