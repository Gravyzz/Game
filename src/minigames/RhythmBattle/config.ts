 ...
 *
 * Для уровня 1 (difficulty=0.25) — лёгкий паттерн ~120 BPM с одиночными нотами.
 * Для уровня 4 (difficulty=1.0) — плотный паттерн с двойниками к концу.
 */
export function generatePattern(difficulty: number, durationMs: number): Note[] {
  ...
  // 0.25 → 700мс, 0.5 → 600мс, 0.75 → 500мс, 1.0 → 420мс
